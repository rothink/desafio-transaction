...
class TransferenciaTest extends TestCase
{
     ...
     * @throws \Exception
     */
    public function testTransferirSaldoInsuficienteException(): void
    {
     ...
     * @throws \Exception
     */
    public function testTransferirValorZeroException(): void
    {
        $this->expectException(\Exception::class);
     ...
     * @throws \Exception
     */
    public function testTransferirUsuarioLogadoDiferenteDoPagadorException(): void
    {
        $this->expectException(\Exception::class);
     ...
     * @throws \Exception
     */
    public function testTransferirMesmoUsuarioException(): void
    {
        $this->expectException(\Exception::class);
     ...
     * @throws \Exception
     */
    public function testTransferirUsuarioPagadorEhLojistaException(): void
    {
        $this->expectException(\Exception::class);
     ...
     * @throws \Exception
     */
    public function testTransferirComFalhaServicoAutorizacaoExternaException(): void
    {
        $this->expectException(\Exception::class);
