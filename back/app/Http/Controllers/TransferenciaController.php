...
class TransferenciaController extends AbstractController
{
     ...
     *              @OA\Property(property="value", type="integer", format="integer", example="10.000", description="Valor da transferência"),
     *              @OA\Property(property="payer", type="integer", format="integer", example="1", description="User pagador"),
     *              @OA\Property(property="payee", type="integer", format="integer", example="2", description="User beneficiário"),
     *          ),
     *      ),
     *      @OA\Response(
     *          response=200,
